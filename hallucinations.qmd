...
3. **Tool inputs have trusted human oversight.** The system presents AI-generated tool input in a form that humans can verify quickly and accurately, with minimal time and minimal fatigue.
:::
...
3. Tool inputs have trusted human oversight. | Show the location in an interactive map.
...
Bijectivity is key: it ensures that results are trusted as long as the tools and their inputs are trusted.
